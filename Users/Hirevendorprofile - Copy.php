                    ...
                    <?php
                      ...
                      /*if (isset($isHired)) {
                        if ($isHired) {
                          ...
                          if (mysqli_num_rows($cehck_hire_result) === 1) {
                      ...
                      if (mysqli_num_rows($cehck_hire_result) > 0) {
                        ...
                        $cehck_hire_query = "SELECT * FROM hiredvendors WHERE VendorID = '$vendorId' AND EventID = '$eventId' AND Status = 'Accepted' AND PackageID = '$packageID'";
                        $cehck_hire_result = mysqli_query($conn, $cehck_hire_query);
                        if (mysqli_num_rows($cehck_hire_result) > 0) {
