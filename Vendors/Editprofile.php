...
if (isset($_POST['update'])) {
    $targetDir = "../img/vendorPP/"; // Folder to store images
...
//--------------------EDIT------------------------------------------------------------
 ...
 $query=mysqli_query($conn,"update allusers set Firstname='$Firstname', Lastname='$Lastname', Email='$Email', Phone='$Phone', Vendortype='$Vendortype', Address='$Address', Postalcode='$Postalcode' where ID = '$_SESSION[userId]'");
            if ($query) {
                  ...
                  <div class="form-group row mb-3">
					...
					<div class="form-group row mb-3">
						...
						<select required name="Vendortype" class="form-control mb-3">
                          <option value=""><?php echo htmlspecialchars($row['Vendortype']); ?></option>
