              ...
              <div class="col-lg-12">
                <div class="login-form">
                  ...
                  if (isset($_POST['Register'])) {
                      ...
                      $query = $conn->prepare("INSERT INTO allusers (Firstname, Lastname, Email, Phone, Userrole, Password) VALUES (?, ?, ?, ?, ?, ?)");
                      $query->bind_param("ssssss", $fname, $lname, $email, $phone, $userrole, $hashedPassword);
